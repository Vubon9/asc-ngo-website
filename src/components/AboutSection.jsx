...
import { Target, Compass, Flag, ShieldCheck, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 sm:p-10 mb-16 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-4">
            <h3 className="text-2xl font-bold text-slate-900">{t('ngoType')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-emerald-800 text-white rounded-2xl p-8 space-y-4 shadow-md">
            ...
            <h3 className="text-xl font-bold">{t('goalTitle')}</h3>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8">
          <h3 className="text-xl font-bold text-slate-900 mb-6 text-center">{t('coreObjectives')}</h3>
